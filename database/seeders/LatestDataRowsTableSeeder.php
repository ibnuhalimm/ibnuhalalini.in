...
class LatestDataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                ...
                'add' => 1,
                'delete' => 1,
                'details' => '{"default":"1","options":{"1":"Uang","2":"Kado"}}',
                'order' => 4,
            ),
            74 => 
            array (
            ...
            array (
                'id' => 80,
                'data_type_id' => 12,
                'field' => 'wedding_gift_belongsto_guest_relationship',
                'type' => 'relationship',
                'display_name' => 'Nama Tamu',
                'required' => 1,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 0,
                'details' => '{"model":"App\\\\Models\\\\Guest","table":"guests","type":"belongsTo","column":"guest_id","key":"id","label":"full_name","pivot_table":"categories","pivot":"0","taggable":"0"}',
                'order' => 3,
            ),
        ));
